...
class OpenInPreferredBrowser(Extension):
    def __init__(self):
        super(OpenInPreferredBrowser, self).__init__()
        self.selection = None
...
class KeywordQueryEventListener(EventListener):
    def on_event(self, event, extension):
        ...
        if query is None:
            ...
            query = ""
            extension.items = [
                                  BrowserItem(extension, "user", extension)
                                  for extension in list_extensions_with_prefs(extension.only_enabled)[
                    "user"
                ]
                              ] + [
                                  BrowserItem(extension, "system", extension)
                                  for extension in list_extensions_with_prefs(extension.only_enabled)[
                    "system"
                ]
                              ]
